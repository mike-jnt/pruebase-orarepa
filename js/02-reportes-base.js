// --- Numeración diaria e históricos ---
  ...
  // C9.32: sello único de negocio para todas las ventas nuevas.
  ...
  function obtenerSiguienteNumeracionDelDia(diaClave) {
    // C9.32: el consecutivo provisional nunca vuelve a empezar desde 1 solo
  ...
  function normalizarVenta(v, index) {
    ...
    return {
      ...
      diaClave,
      // C9.32: no se inventan números a partir del índice del arreglo.
