(() => {
  ...
  async function cargarPaginaMovimientos(reset = false) {
    ...
    try {
      ...
      console.error('[C9.23] Error cargando movimientos:', error);
  ...
  async function cargarAnaliticaCompleta() {
    ...
    try {
      ...
      console.error('[C9.23] No se pudo cargar la analítica completa:', error);
  ...
  async function obtenerResumenDiarioFinanzas(diaClave) {
    try {
      ...
      console.warn(`[C9.23] No se pudo consultar resumenVentasDiario/${diaClave}:`, error);
      return null;
    }
  }
  ...
  async function sincronizarCierresCajaEnFinanzas(forzarRecarga = true, silencioso = false) {
    ...
    try {
      ...
      console.error('[C9.23] No se pudieron sincronizar los cierres:', error);
  ...
  async function sincronizarPagosNominaEnFinanzas(forzarRecarga = true, silencioso = false) {
    ...
    try {
      ...
      console.error('[C9.23] No se pudo sincronizar la nómina:', error);
