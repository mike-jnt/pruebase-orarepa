(() => {
  ...
  function guardarInventarioLocal() {
    try { localStorage.setItem(INVENTARIO_STORAGE_KEY, JSON.stringify(inventario)); } catch (_) {}
  }
